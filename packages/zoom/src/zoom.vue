<template>
    <div class="bl-zoom">
        <img :src="src" :width="width" :height="height" @mouseover="handOver" @mousemove="handMove"
             @mouseout="handOut"/>
    </div>
</template>

<script>
    const COMPONENT_NAME = 'bl-zoom'
    export default {
        name: COMPONENT_NAME,
        props: {
            src: {
        ...
        methods: {
            ...
            handOver() {
                if (!document.getElementById('bl-zoom-layer')) {
                    ...
                    let layerHeight = this.configs.height
                    let layerWidth = this.configs.width
